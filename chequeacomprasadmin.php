...
<head>
    ...
    <title>Ver compras de cliente</title>
</head>
<body>
...
$sql_historial = "SELECT cp.id_compra, cp.nombre_producto, cp.cantidad, c.fech_compra, c.total
                  ...
                  WHERE cp.nick = '$nick' AND c.fech_compra < NOW()";

$resultado_historial = $conexion->query($sql_historial);

echo "<h2>El historial de $nick:</h2>";
...
<a href="admincomprasver.php"><button>Ver otras compras</button></a><br>
<br>

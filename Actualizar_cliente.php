...
$sql = "SELECT Nick,dni,ap1,ap2,tlf,email,tipo_via,nombre_via,num_via,bloque,portal,escalera,planta,puerta,
               nom_loc,nom_prov,contrasenia,nombre FROM cliente WHERE Nick = '$user'";
$res = $conexion->query($sql);

if ($res) {
    echo "<table border=1> <tr> <th>DNI</th><th>Password</th><th>Nombre</th><th>1er Apellido</th><th>2º Apellido</th><th>TLF</th><th>Email</th><th> Vía</th><th> Nomb.Via</th>
...
<body>
    ...
    <br>
    <a href="Inicio.php"><button>Ir al menu</button></a>
</body>
</html>